...
date = datetime.strptime({{ ds }}, '%Y-%m-%d').date() - timedelta(days=1) #'2022-06-21'  отладочная дата 
...
with  DAG(
    ...
    friends_recomendation_job_d60 = SparkSubmitOperator(
        task_id='FriendsRecomendationJob-d60',
        application ='friends_recomendation.py' ,
        conn_id= 'yarn_spark',
        application_args = [
            date,
            '60',
    ...
    events_geo_partitioning_job >> friends_recomendation_job_d60